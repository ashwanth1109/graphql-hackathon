package com.hackathon.microservices.users.deploy;

import com.hackathon.microservices.users.Manager;
import com.hackathon.microservices.users.deploy.stacks.UsersStack;
...
public class Deploy {
    ...
    public void synth() {
        App app = new App();
        String rootStack = Manager.withEnv("users-stack");
        new UsersStack(app, rootStack);
