package com.hackathon.microservices.users.deploy.stacks;
...
import static com.hackathon.microservices.users.Manager.withEnv;

public class UsersStack extends Stack {
    public UsersStack(final Construct parent, String id) {
        super(parent, id);

        String apiName = withEnv("users-api");
        Schema schema = Schema.fromAsset("../User.graphql");
